...
import { NavbarNewsComponent } from './navbar-news/navbar-news.component';
import { ScheduleTimerModule } from 'app/main/schedule-timer/schedule-timer.module';
import { ShiftModule } from 'app/main/shift/shift.module';
...
@NgModule({
  ...
  imports: [RouterModule, NgbModule, CoreCommonModule, PerfectScrollbarModule, CoreTouchspinModule,ScheduleTimerModule],
  providers: [
    {
